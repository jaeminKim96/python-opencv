...
vedio_path = "C:/jaemin/opencv/data/vtest.avi" #-- 사용할 영상 경로
min_confidence = 0.5
...
#-- yolo 포맷 및 클래스명 불러오기
model_file = "./yolo_object_detection/yolov3.weights" #-- 본인 개발 환경에 맞게 변경할 것
config_file = "./yolo_object_detection/yolov3.cfg" #-- 본인 개발 환경에 맞게 변경할 것
